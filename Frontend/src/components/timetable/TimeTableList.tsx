...
export default function TimeTableList({ selectedDate }: { selectedDate: DayKey }) {
  const timetable = [...timetableData[selectedDate]] as { time: string; title: string }[];

  return (
    <AnimatePresence mode="wait">
      <motion.section
        key={selectedDate} // ← 중요! 날짜가 바뀔 때마다 key도 변경되어야 함
